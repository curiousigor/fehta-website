                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/EnruoXm7ijF2Uhhn9">
                                <h3 className="text-gray-500 mb-3">Glavni trg 23, 2000 Maribor</h3>
                            </a>
                            <a href="https://goo.gl/maps/EnruoXm7ijF2Uhhn9">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/3LVpishi8uW2RtWF6">
                                <h3 className="text-gray-500 mb-3">Pobreška cesta 18, 2000 Maribor</h3>
                            </a>
                            <a href="https://goo.gl/maps/3LVpishi8uW2RtWF6">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/DVxUsreCcbEMWEcR7">
                                <h3 className="text-gray-500 mb-3">Mariborska cesta 100, 3000 Celje</h3>
                            </a>
                            <a href="https://goo.gl/maps/DVxUsreCcbEMWEcR7">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/q7Wi8M5ijXVwQpjX6">
                                <h3 className="text-gray-500 mb-3">Megamarket Interspar, Jamova cesta 105, 1000 Ljubljana</h3>
                            </a>
                            <a href="https://goo.gl/maps/q7Wi8M5ijXVwQpjX6">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://g.page/Vegansko?share">
                                <h3 className="text-gray-500 mb-3">Trg mladinskih delovnih brigad 10, 1000 Ljubljana</h3>
                            </a>
                            <a href="https://g.page/Vegansko?share">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://g.page/TrgovinaGust?share">
                                <h3 className="text-gray-500 mb-3">Ljubljanska cesta 73, 1230 Domžale</h3>
                            </a>
                            <a href="https://g.page/TrgovinaGust?share">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/qCb8CFNCx9scG3sx8">
                                <h3 className="text-gray-500 mb-3">Šutna 2, 1241 Kamnik</h3>
                            </a>
                            <a href="https://goo.gl/maps/qCb8CFNCx9scG3sx8">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://g.page/Dobramisel?share">
                                <h3 className="text-gray-500 mb-3">Železniška ulica 5, 4248 Lesce</h3>
                            </a>
                            <a href="https://g.page/Dobramisel?share">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/RPDbF25i5Kkmx8sY6">
                                <h3 className="text-gray-500 mb-3">Trubarjeva cesta 8, 1000 Ljubljana</h3>
                            </a>
                            <a href="https://goo.gl/maps/RPDbF25i5Kkmx8sY6">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
                    ...
                    <div className="h-full flex flex-col items-center text-center">
                        ...
                        <div className="w-full">
                            ...
                            <a href="https://goo.gl/maps/LGLZzfFjiEUqSNrq8">
                                <h3 className="text-gray-500 mb-3">Panonska ulica 8, 9250 Gornja Radgona</h3>
                            </a>
                            <a href="https://goo.gl/maps/LGLZzfFjiEUqSNrq8">
                                <h3 className="text-sm text-red-600 hover:text-red-800 transition duration-200 ease-in-out mb-3 inline-flex items-center">Poglej na Google Maps<svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg></h3>
