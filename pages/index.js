                    ...
                    <div className="container flex flex-col items-center px-5 py-8 mx-auto">
                        <div className="flex flex-col w-full mb-12 text-center">
                            <h1 className="mx-auto mb-12 font-semibold leading-none text-black lg:w-1/2 text-5xl md:text-6xl title-font font-machina">
                                Dobra hrana za fajne ljudi. Poišči nas tam, kjer
                                bi iskal prijatelje.
                            </h1>
                            <p className="mx-auto text-lg font-medium leading-relaxed  lg:w-1/2">
                                Fehta razbija mite o neokusni rastlinski
                                prehrani in nepoznavanju receptov, ter rešuje
                                govorice, da je tofu - fuj, da ga jedo samo
                                obsedeni vegani, ter da je tempeh gobica za
                    ...
                    <div className="container flex flex-col items-center px-5 py-16 mx-auto md:flex-row lg:px-28">
                        <div className="flex flex-col items-start w-full pt-0 mb-16 text-left lg:flex-grow md:w-1/2 xl:mr-20 md:pr-24 md:mb-0 ">
                            ...
                            <p className="mb-8 text-lg leading-relaxed text-left">
                                Je eden najpomembnejših virov beljakovin
                                rastlinskega izvora, ker vsebuje vse bistvene
                                aminokisline, ki so potrebne za normalno
                            ...
                            <p className="flex mb-2">
                                ...
                                Primeren za otroke, starejše in ljudi s
                                prebavnimi težavami
                            </p>
                            <p className="flex items-center mb-4">
                                ...
                                Dovzeten za vpoj drugih okusov v obliki marinad
                                in začimb
                            </p>
                            <div>
                ...
                <section className="pb-0 md:pb-14 md:pt-20">
                    <div className="container flex flex-col items-start px-5 py-16 mx-auto lg:items-center md:flex-row lg:px-28">
                        ...
                        <div className="flex flex-col items-start text-left lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16">
                            ...
                            <p className="mb-8 text-lg leading-relaxed text-left ">
                                Tempeh je izdelan iz kuhane soje, ki je v
                                procesu fermentacije povezana z belkasto,
                                bombažu podobno plemenito plesenijo.
                            </p>
                            <p className="flex mb-2">
                                <span className="inline-flex items-center justify-center flex-shrink-0 w-6 h-6 mr-2 rounded-full">
                                    <svg
                        ...
                        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                            ...
                            <div className="p-4 md:w-1/3 w-full flex flex-col text-center items-center">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="leading-relaxed text-base">
                                        Vitamini, minerali, proteini in
                                        probiotiki za tvoje zdravje.
                                    </p>
                                </div>
                            </div>
                            <div className="p-4 md:w-1/3 w-full flex flex-col text-center items-center">
                        ...
                        <div className="flex flex-wrap -m-4">
                            ...
                            <div className="p-4 md:w-1/3 w-full">
                                <div className="h-full bg-white bg-opacity-70 p-8 rounded">
                                    ...
                                    <p className="leading-relaxed mb-6 text-lg">
                                        Okej, jst lahko živim od tega dimljenega
                                        tofuja in tempeha.
                                    </p>
                            ...
                            <div className="p-4 md:w-1/3 w-full">
                                <div className="h-full bg-white bg-opacity-70 p-8 rounded">
                                    ...
                                    <p className="leading-relaxed mb-6 text-lg">
                                        Dans sva s punco prvič probali vaš tofu.
                                        Tok je bil dobr, da sva stali ob pultu,
                                        ga rezali in celga pojedli brez vsega 😭
                                    </p>
                                    <div className="inline-flex items-center">
                                        <div className="w-12 h-12">
                                            <Image
                            ...
                            <div className="p-4 md:w-1/3 w-full">
                                <div className="h-full bg-white bg-opacity-70 p-8 rounded">
                                    ...
                                    <p className="leading-relaxed mb-6 text-lg">
                                        Veš ono ko doživiš eksistencialno krizo
                                        ko poskusiš Fehta tofu? Kaj sn te jedo
                                        prej?
                                    </p>
                            ...
                            <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:pl-6 lg:text-left">
                                <div className="flex flex-col mb-20 lg:items-start">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <p className="leading-relaxed text-base">
                                            Preveri, kje se nahajajo Fehtine
                                            dobrote, in jih prevzemi v tvoji
                                            najljubši BIO trgovini.
                                        </p>
                                        <a
                                            href="/trgovine"
